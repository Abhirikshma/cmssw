...
enum VerbosityLevel { pDEBUG = 0, pWARNING = 1, pINFO = 2, pERROR = 3 };
 ...
 virtual std::unordered_map<uint32_t, int> populate(const HGCRecHitCollection &hits, std::unordered_map<uint32_t, int> u) = 0;
 virtual void populate(const HGCRecHitCollection &hits) = 0;
 virtual void makeClusters() = 0;
 virtual void makeClusters(const HGCalTopology& topoEE, const HGCalTopology& topoSi, const HGCalTopology& topoScin) = 0;
