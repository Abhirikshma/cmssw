...
class HGCalCLUEAlgo : public HGCalClusteringAlgoBase {
 ...
 HGCalCLUEAlgo(const edm::ParameterSet& ps)
  ...
  std::unordered_map<uint32_t, int> populate(const HGCRecHitCollection &hits, std::unordered_map<uint32_t, int> u);
  ...
  void makeClusters(const HGCalTopology& topoEE, const HGCalTopology& topoSi, const HGCalTopology& topoScin);
  void makeClusters();
 ...
 private:
  ...
  void localDensityModFindSeeds(const unsigned int layerId, const HGCalTopology& topoEE, const HGCalTopology& topoSi, const HGCalTopology& topoScin, google::dense_hash_map<uint32_t, int> u);
  int clusterModified (const unsigned int layerID, const HGCalTopology& topoEE, const HGCalTopology& topoSi, const HGCalTopology& topoScin, google::dense_hash_map<uint32_t, int> u);  
