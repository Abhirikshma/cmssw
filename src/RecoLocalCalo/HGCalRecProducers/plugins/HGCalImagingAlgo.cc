...
std::unordered_map<uint32_t, int> HGCalImagingAlgo::populate(const HGCRecHitCollection &hits, std::unordered_map<uint32_t, int> u){
  return u;
}
...
void HGCalImagingAlgo::makeClusters(const HGCalTopology& topoEE, const HGCalTopology& topoSi, const HGCalTopology& topoScin){}
